...
## 🎯 Purpose
In traditional healthcare settings (especially locally with PhilHealth or HMOs), dealing with misplaced physical receipts, reconciliation errors, and billing disputes can be a frustrating, slow process. 
